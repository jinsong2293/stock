...
#include "/media/jin/databk/Project/stock/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/other_builds/numpy/armeabi-v7a__ndk_target_21/numpy/build/src.linux-x86_64-3.11/numpy/core/src/umath/loops_exponent_log.dispatch.c"
