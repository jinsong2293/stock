...
#include "/media/jin/databk/Project/stock/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/other_builds/numpy/arm64-v8a__ndk_target_21/numpy/build/src.linux-x86_64-3.11/numpy/core/src/umath/loops_arithmetic.dispatch.c"
