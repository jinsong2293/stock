...
SYSLIBS="$LIBM $LIBC"
ABIFLAGS=""
LIBS="-lpython3.10 -ldl  -lsqlite3 -lffi -lcrypto1.1 -lssl1.1 -llzma -lbz2 -lz -lm $SYSLIBS"
LIBS_EMBED="-lpython${VERSION}${ABIFLAGS} -ldl  -lsqlite3 -lffi -lcrypto1.1 -lssl1.1 -llzma -lbz2 -lz -lm $SYSLIBS"
